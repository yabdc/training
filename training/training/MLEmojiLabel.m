...
REGULAREXPRESSION(PhoneNumerRegularExpression, @"\\(?\\d{2}\\)?[\\s\\-]?\\d{4}\\-?\\d{4}")
//REGULAREXPRESSION(PhoneNumerRegularExpression, @"\\d{2}-\\d{8}|\\d{3}-\\d{7}|\\d{4}-\\d{8}|\\d{4}-\\d{7}|1+[358]+\\d{9}|\\d{8}|\\d{7}")
